...
public class AppointmentConfirmation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Move Forward>>>");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 450, 200, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Confimation.png"))); // NOI18N
